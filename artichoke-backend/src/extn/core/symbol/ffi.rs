...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_intern_static(mrb: *mut sys::mrb_state, name: *const c_char, len: usize) -> sys::mrb_sym {
...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_intern_check(mrb: *mut sys::mrb_state, name: *const c_char, len: usize) -> sys::mrb_sym {
    let bytes = slice::from_raw_parts(name.cast::<u8>(), len);
    unwrap_interpreter!(mrb, to => guard, or_else = 0);
...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_check_intern(mrb: *mut sys::mrb_state, name: *const c_char, len: usize) -> sys::mrb_value {
    let bytes = slice::from_raw_parts(name.cast::<u8>(), len);
...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_sym_name(mrb: *mut sys::mrb_state, sym: sys::mrb_sym) -> *const i8 {
